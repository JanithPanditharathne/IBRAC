...
public class CorrelationInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(final HttpServletRequest request, final HttpServletResponse response,
        ...
        final String correlationId = getCorrelationIdFromHeader(request); // Get the correlation id from the header and store in correlationId variable
        ...
        MDC.put(CORRELATION_ID_MDC_ATTRIBUTE_NAME, correlationId); // Put the correlationId Attribute name
        MDC.put(START_DATE_TIME_MDC_ATTRIBUTE_NAME, String.valueOf(System.currentTimeMillis())); // Put the current date time value to the MDC
    ...
    public void afterCompletion(final HttpServletRequest request, final HttpServletResponse response,
        ...
        // Remove the correlationId Attribute name
        MDC.remove(CORRELATION_ID_MDC_ATTRIBUTE_NAME);
        // Remove the current date time value from the MDC
    ...
    private String getCorrelationIdFromHeader(final HttpServletRequest request) {
        ...
        // If the correlation id is empty, then we will generate a new randomUUID
